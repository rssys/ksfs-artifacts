    ...
    ($t_name: ty, $field_name: ident, $c_type: ident, $field_type: ident) => {
        impl $t_name {
            pub fn $field_name(&self) -> $field_type {
                use kernel::ffi::*;
                paste! {
                    let f = [<rs_ $c_type _get_ $field_name>];
                }
    ...
    ($t_name: ty, $setter_name: ident, $field_name: ident, $c_type: ident, $field_type: ident) => {
        impl $t_name {
            pub fn $setter_name(&mut self, obj: $field_type) {
                use kernel::ffi::*;
                paste! {
                    let f = [<rs_ $c_type _set_ $field_name]>;
                }
                unsafe {
...
extern "C" {
    pub fn _printk(fmt: *const raw::c_char, ...) -> raw::c_int;
    ...
    pub fn filp_open(filename: *const raw::c_char, flags: i32, mode: u16) -> *mut raw::c_void;
    pub fn filp_close(filp: *const raw::c_void, owner: *const raw::c_void) -> i32;
    pub fn kernel_write(filp: *const raw::c_void, buf: *const raw::c_void,
        count: usize, pos: *mut i64) -> isize;
    pub fn kernel_read(filp: *const raw::c_void, buf: *mut raw::c_void,
        count: usize, pos: *mut i64) -> isize;
    pub fn vfs_fsync(filp: *const raw::c_void, datasync: i32) -> i32;
    pub fn vfs_llseek(filp: *const raw::c_void, offset: i64, whence: i32) -> i64;
    ...
    pub fn mount() -> i32;
    pub fn blkdev_get_by_path(dev_name: *const raw::c_char,
        mode: u32, holder: *const raw::c_void) -> *mut raw::c_void;
    pub fn get_bdev_helper(dev_name: *const raw::c_char, mode: u32) -> *mut raw::c_void;
    pub fn blkdev_put(bdev: *const raw::c_void, mode: u32);
    pub fn bento_get_blkdev_holder() -> *const raw::c_void;
    pub fn bento_blkdev_get_size(bdev: *const raw::c_void) -> u64;
    pub fn sync_blockdev(bdev: *const raw::c_void) -> i32;
