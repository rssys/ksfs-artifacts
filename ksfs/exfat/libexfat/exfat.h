...
struct exfat_dev* exfat_open_fd(int fd, enum exfat_mode mode);
...
int exfat_lookup(struct exfat* ef, struct exfat_node** node,
		const char* path);
int exfat_lookup_from(struct exfat* ef, struct exfat_node* parent,
		struct exfat_node** node, const char* path);
int exfat_lookup_name(struct exfat* ef, struct exfat_node* parent,
		struct exfat_node** node, const char* name);
