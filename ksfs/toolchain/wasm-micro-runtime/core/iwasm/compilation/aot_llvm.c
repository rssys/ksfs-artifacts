...
aot_set_llvm_basic_types(AOTLLVMTypes *basic_types, LLVMContextRef context)
{
    ...
    basic_types->int8_ptr_type_gs =
        LLVMPointerType(basic_types->int8_type, 257);
    basic_types->int16_ptr_type_gs =
        LLVMPointerType(basic_types->int16_type, 257);
    basic_types->int32_ptr_type_gs =
        LLVMPointerType(basic_types->int32_type, 257);
    basic_types->int64_ptr_type_gs =
        LLVMPointerType(basic_types->int64_type, 257);
    basic_types->float32_ptr_type_gs =
        LLVMPointerType(basic_types->float32_type, 257);
    basic_types->float64_ptr_type_gs =
        LLVMPointerType(basic_types->float64_type, 257);
    basic_types->v128_ptr_type_gs =
        LLVMPointerType(basic_types->v128_type, 257);
